...
const App: React.FC = () => {
  ...
  const html = renderToStaticMarkup(<RenderHtml title={title} setTitle={setTitle} handleSubmit={handleSubmit}/>)
  ...
  return (
    <>
      {boilerPlate ? <RenderHtml title={title} setTitle={setTitle} handleSubmit={handleSubmit}/> :  (<><button onClick={styleTemplate}>STYLE TEMPLATE</button>
